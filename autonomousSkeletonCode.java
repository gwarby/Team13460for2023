...
@Autonomous(name = "skeletonCode")  // ----------------------------------------------------------------- Program name here
  //          And here
public class skeletonCode extends LinearOpMode 
{
  // Declare the variables for our hardware, they will be mapped later      ----------------------------- Hardware names
  ...
  public void runOpMode() 
  {
    ...
    webcam.openCameraDeviceAsync(new OpenCvCamera.AsyncCameraOpenListener()
    {
      ...
      public void onOpened()
      {
        ...
        webcam.startStreaming(544, 288, OpenCvCameraRotation.UPRIGHT);  //320x240  //432x240   //640x480 ------ Change for camera

        findPropPL.ColorChannel = 2;  // channel 1: red,  channel 2: blue  --------------------------------- Change for side
